    ...
    return (
        <div className="flex flex-col-reverse md:flex-row justify-center items-center gap-10 max-w-[1550px] w-[90%] mx-auto poppins" >
            <div data-aos="fade-up"
                data-aos-duration="2000" className="flex-1 grid grid-cols-2 gap-3 justify-center items-center">
            ...
            <div data-aos="fade-up"
                data-aos-duration="3000" className="flex-1 space-y-8">
                <h1  data-aos="fade-up" className="">Welcome to <span className="text-lx font-semibold text-green-900">Eastward journeys</span></h1>
                <h1  data-aos="fade-up" className="text-4xl font-bold">Its time to start your <br /> <span className="text-green-800">Adventure</span></h1>
                <p  data-aos="fade-up">A small river named Duden flows by their place and supplies it with the necessary regelialia. It is a paradisematic country, in which roasted parts of sentences fly into your mouth.
                    <br />
                    <br />
